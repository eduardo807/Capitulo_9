...
#~ Esto significa que podemos usar, crear, escribir y desvincular para modificar datos en el servidor
print api.execute_kw(db, uid, pwd, 'res.partner', 'create', [{'name':'Packt'}])
print api.execute_kw(db, uid, pwd, 'res.partner', 'write', [[45], {'name': 'Packt Pub'}])
print api.execute_kw(db, uid, pwd, 'res.partner', 'read', [[75], ['id', 'name']])
print api.execute_kw(db, uid, pwd, 'res.partner', 'unlink', [[75]])
